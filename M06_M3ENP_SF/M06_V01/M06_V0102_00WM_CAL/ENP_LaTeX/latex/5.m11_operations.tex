...
area.)
\item[]
\item Priority 2: If $Mode=0$ and $H_{us}>=5.0 ft$, discharge according to Table~\ref{tab:CS-S332BN0}.
\item Priority 3: If $Mode=0$ and $H_{us}>=4.7 ft$, discharge according to Table~\ref{tab:CS-S332BN0}.
\item[]
\item Priority 4: If $Mode=1$ and $H_{us}>=5.0 ft$, discharge according to Table~\ref{tab:CS-S332BN1}.
\item Priority 5: If $Mode=1$ and $H_{us}>=4.7 ft$, discharge according to Table~\ref{tab:CS-S332BN1}.
\item[]
\item Priority 6: If $Mode=2$ and $H_{us}>=4.8 ft$,  discharge according to Table~\ref{tab:CS-S332BN2}.
\item Priority 7: If $Mode=2$ and $H_{us}>=4.5 ft$,  discharge according to Table~\ref{tab:CS-S332BN2}.
\item[]
\item Priority 8: Default, close.
\end{packed_items}
...
area.)
\item[]
\item Priority 2: If $Mode=0$ and $H_{us}>=5.0 ft$, discharge according to Table~\ref{tab:CS-S332BW0}.
\item Priority 3: If $Mode=0$ and $H_{us}>=4.7 ft$, discharge according to Table~\ref{tab:CS-S332BW0}.
\item[]
\item Priority 4: If $Mode=1$ and $H_{us}>=5.0 ft$, discharge according to Table~\ref{tab:CS-S332BW1}.
\item Priority 5: If $Mode=1$ and $H_{us}>=4.7 ft$, discharge according to Table~\ref{tab:CS-S332BW1}.
\item[]
\item Priority 6: If $Mode=2$ and $H_{us}>=4.8 ft$,  discharge according to Table~\ref{tab:CS-S332BW2}.
\item Priority 7: If $Mode=2$ and $H_{us}>=4.5 ft$,  discharge according to Table~\ref{tab:CS-S332BW2}.
\item[]
\item Priority 8: Default, close.
\end{packed_items}
...
area.)
\item[]
\item Priority 2: If $Mode=0$ and $H_{us}>=5.0 ft$, discharge according to Table~\ref{tab:CS-S332C0}.
\item Priority 3: If $Mode=0$ and $H_{us}>=4.7 ft$, discharge according to Table~\ref{tab:CS-S332C0}.
\item[]
\item Priority 4: If $Mode=1$ and $H_{us}>=5.0 ft$, discharge according to Table~\ref{tab:CS-S332C1}.
\item Priority 5: If $Mode=1$ and $H_{us}>=4.7 ft$, discharge according to Table~\ref{tab:CS-S332C1}.
\item[]
\item Priority 6: If $Mode=2$ and $H_{us}>=4.8 ft$,  discharge according to Table~\ref{tab:CS-S332C2}.
\item Priority 7: If $Mode=2$ and $H_{us}>=4.5 ft$,  discharge according to Table~\ref{tab:CS-S332C2}.
\item[]
\item Priority 8: Default, close.
\end{packed_items}
...
These are the approximate locations of the trigger points in the model:
\begin{packed_items}
