...
\begin{packed_items}
\item Priority 1: When $Mode=0$, $Q = Q_{obs}$
\item Priority 2: When $Mode>=1$ and $H_{us} > 3.8$ ft and $YEAR = 2012$ and $MONTH >=7$, discharge according to Table~\ref{tab:CS-S200}
\item Priority 3: When $Mode>=1$ and $H_{us} > 3.8$ ft and $YEAR >= 2013$, discharge according to Table~\ref{tab:CS-S200}
\item Priority 4: When $Mode>=1$ and $H_{us} > 3.6$ ft, remain unchanged
\item Priority 5: Close.
\end{packed_items}
...
\begin{packed_items}
\item Priority 1: When $Mode=0$, $Q = Q_{obs}$
\item Priority 2: When $Mode>=1$ and $H_{us} > 3.8$ ft and $YEAR = 2012$ and $MONTH >=6$, discharge according to Table~\ref{tab:CS-S199}
\item Priority 3: When $Mode>=1$ and $H_{us} > 3.8$ ft and $YEAR >= 2013$, discharge according to Table~\ref{tab:CS-S199}
\item Priority 4: When $Mode>=1$ and $H_{us} > 3.6$ ft, remain unchanged
\item Priority 5: Close.
\end{packed_items}
