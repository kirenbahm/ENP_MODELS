...
\item Priority 4: If $Mode=2$ and \textcolor[rgb]{1.00,0.00,0.00}{HW $>$ 4.7 ft}, discharge according to Table~\ref{tab:CS-S332BN2}
...
\item Priority 4: If $Mode=2$ and \textcolor[rgb]{1.00,0.00,0.00}{ HW $>$ 4.7 ft}, discharge according to Table~\ref{tab:CS-S332BW2}
\item Priority 5: When stage $<$ 0.0, close
\end{packed_items}
...
\begin{packed_items}
\item Priority 1: When \textcolor[rgb]{1.00,0.00,0.00}{Hds $<$ 99.999}, close (this is a placeholder to reflect any design criteria for the detention area)
\item Priority 2: If $Mode=0$ and HW $>$ 4.7 ft, discharge according to Table~\ref{tab:CS-S332C0}
\item Priority 3: If $Mode=1$ and HW $>$ 4.7 ft, discharge according to Table~\ref{tab:CS-S332C1}
\item Priority 4: If $Mode=2$ and HW $>$ 4.5 ft, discharge according to Table~\ref{tab:CS-S332C2}
\item Priority 5: When stage $<$ 0.0, close
\end{packed_items}
