...
\item Priority 3: If $Mode=0$ and $H_{ds}=G211\_TW_{obs}$, Close.
\item[]
...
\item Priority 3: If $Mode=0$ and headwater S-331 $>$ 0.0, discharge according to observed discharge timeseries through S-331 Pump ($Q = Q_{obs}$).
\item Priority 4: If $Mode>0$ and water level at Angels Well is $>=$ 6.0 ft., discharge according to Table~\ref{tab:CS-S331Pa}
\item Priority 5: If $Mode>0$ and water level at Angels Well is $>=$ 5.75 ft., discharge according to Table~\ref{tab:CS-S331Pb}
\item Priority 6: If $Mode>0$ and water level at Angels Well is $>=$ 5.5 ft., discharge according to Table~\ref{tab:CS-S331Pc}
