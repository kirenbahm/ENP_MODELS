...
\item Priority 3: If $Mode=0$ and $H_{ds}=G211\_TW_{obs}$, operate according to Table~\ref{tab:CS-G211close}.
\item[]
...
\item Priority 3: If $Mode=0$ and $H_{ds}>S176\_TW_{obs}$, operate according to Table~\ref{tab:CS-S176close}.
\item[]
...
\item Priority 3: If $Mode=0$ and $H_{ds}>S177\_TW_{obs}$, operate according to Table~\ref{tab:CS-S177close}.
\item[]
...
\item Priority 3: If $Mode=0$ and $H_{ds}=S18C\_TW_{obs}$, operate according to Table~\ref{tab:CS-S18Cclose}.
\item[]
