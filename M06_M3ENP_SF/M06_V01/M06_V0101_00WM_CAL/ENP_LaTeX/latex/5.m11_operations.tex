...
\begin{packed_items}
\item Priority 1: If $Mode=1$: Close.
\item Priority 2: If $Mode=2$: Close.
...
\item Priority 3: If $Mode=0$ and $H_{us}>5.4999 ft$, remain unchanged.
\item[]
\item Priority 4: If $Mode=1$ and $H_{us}>=6.0 ft$, operate according to Table~\ref{tab:CS-G211open}.
\item Priority 5: If $Mode=1$ and $H_{us}>=5.4999 ft$, remain unchanged.
\item[]
\item Priority 6: If $Mode=2$ and $H_{us}>=5.6999 ft$, operate according to Table~\ref{tab:CS-G211open}.
\item Priority 7: If $Mode=2$ and $H_{us}>=5.2999 ft$, remain unchanged.
\item[]
\item Priority 8: If $Mode=0$ and $S331P\_Q>1000 cfs$, close.
...
\begin{packed_items}
\item Priority 1: If $S176HW < 3.99 ft$ and $Mode>=0$ and $S331P\_Q < 0.1 cfs$ and $S173HW > S173TW$ operate according to Table~\ref{tab:CS-S173ops-open}. %all modes
\item Priority 2: If $S177\_H < 2.99 ft$ and $Mode>=0$ and $S331P\_Q < 0.1 cfs$ operate according to Table~\ref{tab:CS-S173ops-open}. %all modes
\item Priority 3: Close.
\end{packed_items}
...
\begin{packed_items}
\item Priority 1: If S331P flow $<$ 0.1 cfs, and S176HW $<$ 5.4999 ft, and $Mode>=0$  discharge according to control strategy in Table~\ref{tab:CS-S331SA}.
\item Priority 2: Close.
\end{packed_items}
...
\begin{packed_items}
\item Priority 1: If $Mode>=0$, $Q = Q_{obs}$.
\item Priority 2: If $Mode>=0$ and headwater at S-176 $>$ 5.4999 ft., close.
\item Priority 3: If $Mode=0$ and headwater S-331 $>=$ 5.999, close.
\item Priority 4: If $Mode>=0$ and water level at Angels Well is $>$ 5.999 ft., close.
\item Priority 5: If $Mode>=0$ and water level at Angels Well is $>$ 5.749 ft., close.
\item Priority 6: If $Mode>=0$ and water level at Angels Well is $>$ 5.499 ft., close.
\item Priority 7: Close.
...
\item[]
\item Priority 3: If $Mode=1$ and $H_{us}>=4.999 ft$, discharge according to Table~\ref{tab:CS-S332BN1}.
...
area.)
\item[]
\item Priority 2: If $Mode=0$ and $H_{us}>0$, $Q = Q_{obs}$.
\item[]
...
area.)
\item[]
\item Priority 2: If $Mode=0$ and $H_{us}>=0 ft$, $Q = Q_{obs}$.
\item[]
...
S338-Q operations:
\begin{packed_items}
\item Priority 1: If $Mode=0$ and $H_{us}>0 ft$, $Q = Q_{obs}$.
\item Priority 2: Close.
\end{packed_items}
