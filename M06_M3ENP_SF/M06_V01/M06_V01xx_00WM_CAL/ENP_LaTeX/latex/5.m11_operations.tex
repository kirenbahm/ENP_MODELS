...
%----------------------------------------------------------
\subsection{Canal Operations: Tram Road Borrow Canal}
%----------------------------------------------------------
\begin{figure}[!h]
  \begin{center}
...
%----------------------------------------------------------
\subsection{Canal Operations: L-67A, L-67C, and the Pocket}
%----------------------------------------------------------
...
%----------------------------------------------------------
\subsection{Canal Operations: L-29}
%----------------------------------------------------------
...
\clearpage
%----------------------------------------------------------
\subsubsection{L29 plug between S14 and S12A}
%----------------------------------------------------------
Name: L29plugWofS12

The L29 is plugged between S14 and S12A, and separates the western reach of L29 from WCA3A.

In the model, this plug is implemented as a closed control structure.

%\begin{figure}[!h]
%  \begin{center}
%  \includegraphics[width=4.0in]{../figs/L29plug.png}
%  \caption{"L29 plug" location.}
%  \label{fig:L29plug}
%  \end{center}
%\end{figure}
%
%\begin{figure}[!h]
%  \begin{center}
%  \includegraphics[width=6.0in]{../figs/S12A_area.png}
%  \caption{S12A area, including S14 and L29 "plug".}
%  \label{fig:s12aarea}
%  \end{center}
%\end{figure}
...
%\begin{figure}[!ht] \begin{center}
%  % Requires \usepackage{graphicx}
%  \includegraphics[width=6.5in]{MODEL/FIGURE/L29plugWofS12_HW_TS.png}
%  \caption[Headwater at structure L29plugWofS12]{Headwater at structure L29plugWofS12}\label{fig:L29plugWofS12_HW:STRUCTURE}\end{center}
%\end{figure}
%
%\begin{figure}[!ht] \begin{center}
%  % Requires \usepackage{graphicx}
%  \includegraphics[width=6.5in]{MODEL/FIGURE/L29plugWofS12_TW_TS.png}
%  \caption[Tailwater at structure L29plugWofS12]{Tailwater at structure L29plugWofS12}\label{fig:L29plugWofS12_TW:STRUCTURE}\end{center}
%\end{figure}
%
%\begin{figure}[!ht] \begin{center}
%  % Requires \usepackage{graphicx}
%  \includegraphics[width=6.5in]{MODEL/FIGURE/L29plugWofS12_Q_TS.png}
%  \caption[Flowrate at structure L29plugWofS12]{Flowrate at structure L29plugWofS12}\label{fig:L29plugWofS12_Q:STRUCTURE}\end{center}
%\end{figure}

%\begin{figure}[!ht] \begin{center}
%  % Requires \usepackage{graphicx}
%  \includegraphics[width=6.5in]{MODEL/FIGURE/L29plugWofS12_Q-acc.png}
%  \caption[Accumulated flow at structure L29plugWofS12]{Accumulated flow at structure L29plugWofS12}\label{fig:L29plugWofS12_Q:ACC}\end{center}
%\end{figure}
...
\begin{packed_items}
\item Priority 1: If $Mode=1$ and $H_{ds}<S333\_TW_{obs}$,  operate according to Table~\ref{tab:CS-S333open}.
\item Priority 2: If $Mode=1$ and $H_{ds}>S333\_TW_{obs}$,  operate according to Table~\ref{tab:CS-S333close}.
\item[]
\item Priority 3: If $Mode=2$ and $H_{ds}<S333\_TW_{obs}$,  operate according to Table~\ref{tab:CS-S333open}.
...
\item Priority 6: If $Mode=0$ and $H_{ds}>S333\_TW_{obs}$ and $Q_{str}>1300$ cfs,  operate according to Table~\ref{tab:CS-S333close}.
\item[]
...
\item[]
\item Priority 3: If $Mode=2$ and $H_{ds}<S334\_TW_{obs}$,  operate according to Table~\ref{tab:CS-S334open}.
\item Priority 4: If $Mode=2$ and $H_{ds}>S334\_TW_{obs}$,  operate according to Table~\ref{tab:CS-S334close}.
\item[]
\item Priority 5: If $Mode=0$ and $H_{ds}<S334\_TW_{obs}$ and $Q_{str}<800$ cfs,  operate according to Table~\ref{tab:CS-S334openB}.
\item Priority 6: If $Mode=0$ and $H_{ds}>S334\_TW_{obs}$ and $Q_{str}>800$ cfs,  operate according to Table~\ref{tab:CS-S334closeB}.
\item[]
\item Priority 7: If $H<0$, operate according to Table~\ref{tab:CS-S334closeB}.
\end{packed_items}
...
\begin{table}[!h]
\centering
\caption{Control strategy for S334 open B (units are ft. NGVD29)}
...
\begin{table}[!h]
\centering
\caption{Control strategy for S334 close B (units are ft. NGVD29)}
...
\clearpage
%----------------------------------------------------------
\subsection{Canal Operations: L-67EXT}
%----------------------------------------------------------
\subsubsection{S12E}
%----------------------------------------------------------
...
\clearpage
%----------------------------------------------------------
\subsection{Canal Operations: L-30}
%----------------------------------------------------------
%----------------------------------------------------------
...
\begin{packed_items}
\item Priority 1: If $Mode=1$ and $H_{ds}<S335\_TW_{obs}$,  operate according to Table~\ref{tab:CS-S335open}.
...
\item[]
\item Priority 3: If $Mode=2$ and $H_{ds}<S335\_TW_{obs}$,  operate according to Table~\ref{tab:CS-S335open}.
...
\item Priority 6: If $Mode=0$ and $H_{ds}>S335\_TW_{obs}$ and $Q_{str}>800$ cfs,  operate according to Table~\ref{tab:CS-S335close}.
\item[]
...
\clearpage
%----------------------------------------------------------
\subsection{Canal Operations: C-4}
%----------------------------------------------------------
%----------------------------------------------------------
\subsubsection{S336}
%----------------------------------------------------------
...
%----------------------------------------------------------
\subsection{Canal Operations: L-31N}
%----------------------------------------------------------
%----------------------------------------------------------
\subsubsection{G211}
%----------------------------------------------------------
...
\begin{packed_items}
\item Priority 1: If $Mode>0$ and  HW-TW $<$ 0 ft, Close.
\item Priority 2: If $Mode>0$ and  S331P flow $>$ 0 cfs, Close.
\item Priority 3: \textcolor[rgb]{1.00,0.00,0.00}{If $Mode>0$ and  S331P flow $>$ 0 cfs, discharge according to control strategy in Table~\ref{tab:CS-S173ops}.}
\item Priority 4: Close when headwater is less than 0.0 ft.
\end{packed_items}
...
\begin{packed_items}
\item Priority 1: If $Mode>0$ and S331P flow $<$ 0.1 cfs, and S176HW $<$ 5.5 ft, discharge according to control strategy in Table~\ref{tab:CS-S331SA}.
\item Priority 2: If $Mode=0$ and S331S\_TW $<$ $S331STW_{obs}$, discharge according to control strategy in Table~\ref{tab:CS-S331SB}.
...
\begin{packed_items}
\item Priority 1: When Hups $<$ 0, discharge according to Table~\ref{tab:CS-S332BN}
\item Priority 2: When Hups $>$ 0, remain unchanged
...
In the model the pumps discharge according to the following rules:
\begin{packed_items}
\item Priority 1: When HW $>$ 4.650 ft, discharge according to Table~\ref{tab:CS-S332BW}
...
In the model two control structures are implemented at the same location, to allow for different operations during the wet and dry seasons.
The first control structure (S332D1) operates all year.  The S332D1 control strategy is as follows:
...
\clearpage
%----------------------------------------------------------
\subsection{Canal Operations: C-357}
%----------------------------------------------------------
In order to provide enhanced flood protection for the remaining 8.5 SMA (Las Palmas), the canal C-357, the levee L-357 and the pump station S-357 were built.
...
\clearpage
%----------------------------------------------------------
\subsection{Canal Operations: C-358}
%----------------------------------------------------------
...
\clearpage
%----------------------------------------------------------
\subsection{Canal Operations: C-102}
%----------------------------------------------------------
%----------------------------------------------------------
\subsubsection{S194}
%----------------------------------------------------------
...
\clearpage
%----------------------------------------------------------
\subsection{Canal Operations: C-103}
%----------------------------------------------------------
%----------------------------------------------------------
\subsubsection{S196}
%----------------------------------------------------------
...
\clearpage
%----------------------------------------------------------
\subsection{Canal Operations: L-31W}
%----------------------------------------------------------
%----------------------------------------------------------
\subsubsection{S174}
%----------------------------------------------------------
...
%----------------------------------------------------------
This structure is a series of culverts connecting the S332D High Head Cell to the L31W canal. It is intended to direct water from the HHC northward into the SDA.
...
\clearpage
%----------------------------------------------------------
\subsection{Canal Operations: C-111}
%----------------------------------------------------------
%----------------------------------------------------------
\subsubsection{S176}
%----------------------------------------------------------
...
\clearpage
%----------------------------------------------------------
\subsection{Canal Operations: C-111E}
%----------------------------------------------------------
%----------------------------------------------------------
\subsubsection{S178}
%----------------------------------------------------------
